...
if __name__ == "__main__":
    ...
    gains.extend([[0,1,0,1],[0,10,0,1],[0,0,10,1],[0,0,1,1],[0.0001,0.001,0,500],[0.0001,0,0.001,500],[0.001,0.001,0.001,1000],[0.1,0.0001,0,1]])
    gains.extend([[1,1,1,-1],[1000,1,1,-1],[1,1000,1,-1],[1,1,1000,-1],[1,1,1,-1000],[1,0,0,-1000]])
