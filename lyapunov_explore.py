...
if __name__ == "__main__":
    ...
    # baseline
    # gains = [[0.65,0,0,0],[0.8,0,0,0],[0.85,0,0,0]]
    # gains = [[0.01,100,0,100]]

    # more robots -- 786, 390
    # 0.05, 0.5 -- 730, 245
    # 0.025 -- 619, 438
    # 0.005/15 -- 781, 523
    # gains = [[0.005,250,0,100],[0.005,500,0,100],[0.35,0,0,0],[0.55,0,0,0],[0.65,0,0,0],[0.8,0,0,0],[0.85,0,0,0],[0.95,0,0,0],[0.01,100,0,100]]

    # more obstacles -- 562, 176
    # 5 -- 504, 182
    # 50 -- 493, 183
    # 0.01 -- 584, 399 !!!! try adding kQ now
    # 0.005 --
    # gains = [[0.01,10,0,100]]
    # gains = [[0.7,0,0,0],[0.8,0,0,0]]

    # more area -- 646, 157
    # 2.5 -- 452, 601
    # 5 -- 369, 94
    # 3 --
    # gains = [[0.01,50,0,100],[0.01,100,0,100],[0.005,0,0,100],[0.005,10,0,100],[0.005,100,0,100],[0.6,0,0,0],[0.7,0,0,0],[0.8,0,0,0],[0.85,0,0,0],[0.95,0,0,0]] # TODO
    gains = [[0.002,100,0,100]]
