...
if __name__ == "__main__":
    ...
    for kq in [0.0001,0.01,1]:
        for kY in [1,10,500,1000]:
            gains.append([kq,0,0,kY])
    gains.extend([[10,0,0,1],[100,0,0,1]])
    gains.extend([[0,1,0,1],[0,10,0,1],[0,0,10,1],[0,0,1,1],[0.0001,0.001,0,500],[0.0001,0,0.001,500],[0.001,0.001,0.001,1000],[0.1,0.0001,0,1],[0.01,0.01,0.01,1]])
    gains.extend([[1,1,1,-1],[10,0,0,-1],[100,0.01,0.01,-1],[100,0.01,0.01,-100]])
